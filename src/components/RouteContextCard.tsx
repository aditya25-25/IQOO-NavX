...
export const RouteContextCard: React.FC<RouteContextCardProps> = ({ context }) => {
  ...
  return (
    <div className="w-full px-4 select-none">
      <div className="p-3 rounded-2xl bg-[#131722]/85 backdrop-blur-md border border-white/10 space-y-2">
        <div className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-neutral-400 font-display">
          <Milestone size={14} className="text-[#ff4800]" />
        ...
        <div className="flex flex-wrap gap-1.5">
          {context.isHighway && (
            <div className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-blue-950/60 border border-blue-500/30 text-[11px] font-semibold text-blue-300">
              <Milestone size={12} className="text-blue-400" />
          ...
          {context.isUnpaved && (
            <div className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-amber-950/60 border border-amber-500/40 text-[11px] font-semibold text-amber-300">
          ...
          {context.hasRoadClosure && (
            <div className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-red-950/60 border border-red-500/50 text-[11px] font-semibold text-red-300">
        ...
        <div className="space-y-1 pt-1">
          {context.details.map((detail, idx) => (
            <p key={idx} className="text-[11px] text-neutral-300 flex items-center gap-1.5">
